...
const FORM_FIELD_SLOT_MIGRATION_WARNING =
  '[Form] BREAKING CHANGE: Named field slot control bindings moved to `slotProps.componentProps`. Replace `v-bind="slotProps"` with `v-bind="slotProps.componentProps"`.';
